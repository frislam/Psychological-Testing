          ...
          <div className="p-8 pb-12">
            ...
            <div className="bg-orange-50 rounded-2xl p-6 border border-orange-200 mb-6">
              ...
              <textarea
                ...
                placeholder="পরীক্ষা সম্প��্কে আপনার মন্তব্য..."
                rows="5"
            ...
            <div ref={pdfRef} style={{ display: 'none' }}>
              <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif', fontSize: '12px' }}>
                <h1 style={{ textAlign: 'center', marginBottom: '10px', fontSize: '16px', fontWeight: 'bold' }}>
                  Stroop Test Report
                </h1>
                ...
                {/* Participant Info */}
                <h3 style={{ fontSize: '13px', fontWeight: 'bold', marginBottom: '8px' }}>পরীক্ষণ পাত্রের তথ্য</h3>
                <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '15px' }}>
                  <tr>
                    <td style={{ border: '1px solid #ddd', padding: '6px', fontWeight: 'bold' }}>নাম:</td>
                    <td style={{ border: '1px solid #ddd', padding: '6px' }}>{participantInfo.name}</td>
                  </tr>
                  <tr>
                    <td style={{ border: '1px solid #ddd', padding: '6px', fontWeight: 'bold' }}>বয়স:</td>
                    <td style={{ border: '1px solid #ddd', padding: '6px' }}>{participantInfo.age} বছর</td>
                  </tr>
                  <tr>
                    <td style={{ border: '1px solid #ddd', padding: '6px', fontWeight: 'bold' }}>লিঙ্গ:</td>
                    <td style={{ border: '1px solid #ddd', padding: '6px' }}>{participantInfo.gender === 'male' ? 'পুরুষ' : 'নারী'}</td>
                  </tr>
                  <tr>
                    <td style={{ border: '1px solid #ddd', padding: '6px', fontWeight: 'bold' }}>শিক্ষা:</td>
                    <td style={{ border: '1px solid #ddd', padding: '6px' }}>{participantInfo.education}</td>
                  </tr>
                </table>
                ...
                {/* Test Results */}
                <h3 style={{ fontSize: '13px', fontWeight: 'bold', marginBottom: '8px' }}>পরীক্ষার ফলাফল</h3>
                <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '15px' }}>
                  <tr style={{ backgroundColor: '#f0f0f0' }}>
                    <td style={{ border: '1px solid #ddd', padding: '6px', fontWeight: 'bold' }}>পর্যায়</td>
                    <td style={{ border: '1px solid #ddd', padding: '6px', fontWeight: 'bold' }}>গড় সময় (ms)</td>
                    <td style={{ border: '1px solid #ddd', padding: '6px', fontWeight: 'bold' }}>সঠিক</td>
                    <td style={{ border: '1px solid #ddd', padding: '6px', fontWeight: 'bold' }}>ভুল</td>
                  </tr>
                  <tr>
                    <td style={{ border: '1px solid #ddd', padding: '6px' }}>ফেজ ১: সাধারণ</td>
                    <td style={{ border: '1px solid #ddd', padding: '6px' }}>{getStats(results.congruent).avg}</td>
                    <td style={{ border: '1px solid #ddd', padding: '6px' }}>{getStats(results.congruent).correct}</td>
                    <td style={{ border: '1px solid #ddd', padding: '6px' }}>{getStats(results.congruent).incorrect}</td>
                  </tr>
                  <tr>
                    <td style={{ border: '1px solid #ddd', padding: '6px' }}>ফেজ ২: চ্যালেঞ্জ</td>
                    <td style={{ border: '1px solid #ddd', padding: '6px' }}>{getStats(results.incongruent).avg}</td>
                    <td style={{ border: '1px solid #ddd', padding: '6px' }}>{getStats(results.incongruent).correct}</td>
                    <td style={{ border: '1px solid #ddd', padding: '6px' }}>{getStats(results.incongruent).incorrect}</td>
                  </tr>
                </table>

                <p style={{ fontWeight: 'bold', marginBottom: '8px' }}>Stroop Interference Score: +{getStats(results.incongruent).avg - getStats(results.congruent).avg} ms</p>

                <hr style={{ marginBottom: '15px' }} />

                {/* Analysis */}
                <h3 style={{ fontSize: '13px', fontWeight: 'bold', marginBottom: '8px' }}>বিশ্লেষণ</h3>
                <p style={{ lineHeight: '1.5', marginBottom: '15px' }}>{getAnalysis()}</p>

                <hr style={{ marginBottom: '15px' }} />

                {/* Comments */}
                <h3 style={{ fontSize: '13px', fontWeight: 'bold', marginBottom: '8px' }}>মন্তব্য</h3>
                <p style={{ lineHeight: '1.5', backgroundColor: '#f9f9f9', padding: '10px', borderLeft: '3px solid #f97316' }}>
                  {comment}
                </p>

                <hr style={{ marginTop: '15px' }} />
                <p style={{ fontSize: '10px', color: '#666', textAlign: 'center', marginTop: '10px' }}>
                  Psychological Assessment Lab | Kazi Azimuddin College, Gazipur
                </p>
              </div>
            </div>
